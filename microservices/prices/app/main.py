...
app = FastAPI(docs_url="/prices/docs", openapi_url="/prices/openapi")
...
app.include_router(PriceRouter, tags=["Price"], prefix="/prices/price")
app.include_router(
    AdditionalServiceRouter,
    tags=["AdditionalService"],
    prefix="/prices/additionalservice",
)
