...
class Logger:
    ...
    try:
        ...
        sys.stderr.write(f"backend :: ERROR :: Failed to create log directory: {e}.\n")
        sys.exit(1)

    sys.stderr.write(f"backend :: INFO :: Writing logs to {log_dir}.\n")
    ...
    file_handler = RotatingFileHandler(
        os.path.join(log_dir, "backend.log"), "a", 2e7, 20
    )
